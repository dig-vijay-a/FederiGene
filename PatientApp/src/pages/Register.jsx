...
- **Subscription Services:** Access is provided on a subscription basis.
...
- **Zero-Knowledge Architecture:** Raw data never leaves your device or institution's firewall.
...
Your account is protected by Password and Security Questions.
...
export default function Register() {
    ...
    // Steps: 1 = Details, 2 = Security Vault (TOTP), 3 = Success
    ...
    const handleFormNext = async (e) => {
        ...
        if (!formData.last_name.trim()) { showToast('Last name is required.', 'error'); return; }
        ...
        try {
            ...
            setRegStep(2); // Move to TOTP scanning
        } catch (err) {
            ...
            <div className="glass-card auth-card">
                ...
                {regStep === 1 && (
                    <form onSubmit={handleFormNext} className="auth-form">
                        <div className="form-group">
                            ...
                            {availLoading.username && <span className="input-hint" style={{ fontSize: '0.8rem', opacity: 0.6 }}>Checking...</span>}
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            {availLoading.email && <span className="input-hint" style={{ fontSize: '0.8rem', opacity: 0.6 }}>Checking...</span>}
                        </div>
                                ...
                                return (
                                    <div key={idx} className="security-question-row">
                                        <select 
                                            ...
                                            onChange={e => handleAnswerChange(idx, 'question_id', e.target.value)} 
                                            required
                                        >
                        ...
                        <div className="terms-agree-container">
                            ...
                            <label htmlFor="terms">I agree to the <span className="terms-link" onClick={(e) => { e.preventDefault(); setShowTerms(true); }}>Terms & Conditions</span></label>
                        </div>
                ...
                {regStep === 3 && (
                    <div className="auth-form success-step" style={{ textAlign: 'center' }}>
                        ...
                        <h3>Almost there!</h3>
                        <p>We've sent a verification link to <strong>{formData.email}</strong>. Please check your terminal/email to verify.</p>
